...
<div class="wrap rumsst-admin-page">
    ...
    <div class="rumsst_content_wrapper">
        ...
        <div class="rumsst_content_cell" id="rumsst_content_top">
            <p class="plugin-description">Simple Side Tab was created to give you an easy option for adding a linkable tab to the side of your WordPress website. Use it to link to your contact/support/feedback page or use it to drive traffic to a new product you just released. It's quick and easy.</p>
        ...
        <div class="rumsst_content_cell" id="sidebar-container">
            <div class="rumsst_content_cell_title rumsst-sidebar__title">
    			Rumspeed recommends...
            </div>
            <div class="rumsst-sidebar__section">
                ...
                <ul>
                    ...
                    <li><strong>Want a list of all the plugins on your site with version numbers? We've got you covered. Is a plugin stuck and not getting updated? We check version numbers and we'll let you know if something isn't right.</strong></li>
                    <li><strong>Easily identify if a site is on an older version of WordPress</strong></li>
